...
if ($dbh) {
    $sql = 'INSERT INTO `shoot_time_tb` (`game_id`, `pointed_flag`, `shoot_team_id`, `number`, `tag`, `catch_time`, `release_time`, `goal_time`, `video_time`) VALUES (' . $game_id . ', ' . $pointed_flag . ', ' . $shoot_team_id . ', ' . $shoot_tag . ', "' . $shoot_memo . '", ' . $catch_time . ', ' . $release_time . ', ' . $shoot_goal_time . ', ' . $video_time . ')';
